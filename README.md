...
Our team's submission for the **Nitor Energy Quantitative Trading Case Competition**. The objective was to act as quantitative traders and build a machine learning pipeline to forecast short-term wholesale electricity prices using real-world weather and market data
